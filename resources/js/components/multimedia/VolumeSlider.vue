<template>
    <div id="volume-slider" ref="volumeSlider" class="ma-0 pa-0">
        <svg id="volume-icon" ref="volumeIcon" class="volume-icon" viewBox="-1 0 33 32">
            <defs>
                <mask id="circle-mask" ref="circleMaskShape" x="-1" y="0" width="33" height="32">
                    <circle cx="-1" cy="16" r="33" fill="white" id="circle-mask-shape" />
                </mask>

                <mask id="volume-mask" ref="volumeMask" x="-1" y="0" width="33" height="32">
                ...
                <linearGradient id="grad-1" ref="grad1" x1="0" x2="1" y1="0" y2="0">
        ...
        <div class="volume-track">
            <span id="volume-indicator" ref="volumeIndicator" class="volume-indicator"></span>
            <input type="hidden" name="volume" id="volume-input" ref="volumeInput" />
        </div>
    </div>
...
export default {
  ...
  mounted () {
    class VolumeSlider {
      constructor (refs) {
        console.log(refs)
        this.slider = refs.volumeSlider
        this.icon = refs.volumeIcon
        this.indicator = refs.volumeIndicator
        this.shape = refs.circleMaskShape
        this.input = refs.volumeInput
    ...
    this.volumeSlider = new VolumeSlider(this.$refs)
